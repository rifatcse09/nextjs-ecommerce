                ...
                <div className="rbt-video-gallery position-relative">
                  <div className="video-item">
                    <Image
                      ...
                      src="/assets/images/product-single/vedio-rev-img/vedio-review-img-02.webp"
                      width={624}
                      height={350}
                    />
                    <video
                ...
                <div className="rbt-video-body d-flex">
                  <div className="rbt-reviewer-img">
                    <Image
                      ...
                      src="/assets/images/product-single/vedio-rev-img/reviewer-img-01.webp"
                      width={64}
                      height={64}
                    />
                  </div>
              ...
              >
                <div className="rbt-video-gallery position-relative">
                  <div className="video-item">
                    <Image
                      alt="Ecommerce Review Video Image"
                      src="/assets/images/product-single/vedio-rev-img/vedio-review-img-03.webp"
                      width={624}
                      height={350}
                    />
                    <video
              ...
              >
                <div className="rbt-video-gallery position-relative">
                  <div className="video-item">
                    <Image
                      alt="Ecommerce Review Video Image"
                      src="/assets/images/product-single/vedio-rev-img/vedio-review-img-04.webp"
                      width={624}
                      height={350}
                    />
                    <video
