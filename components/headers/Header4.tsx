...
export default function Header4({ sticky = false }) {
  ...
  return (
    <header className="rbt-header rbt-header-4">
        ...
        <div className="container">
          <div className="rbt-header-sec align-items-center rbt-gap--48 justify-content-between mainbar-row">
            ...
            <div className="rbt-header-sec-col">
              <div className="rbt-header-content">
                {/* Navbar Icons */}
                <ul className="rbt-quick-access rbt-gap--20">
                  <li className="rbt-access-box rbt-scroll-trigger fade_in animation-order-1 rbt-access-box-has-bg-hover d-none d-lg-flex">
                    <Link className="rbt-access-box-wrapper" href={`/wishlist`}>
      ...
      <div className="rbt-catagories-area d-none d-xl-block">
        ...
        <div className="container">
          <ul className="rbt-cat-box-grp d-flex justify-content-center liststyle justify-content-between">
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-chair" />
                </span>
            ...
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-bath" />
                </span>
            ...
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-lamp" />
                </span>
            ...
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-booth-curtain" />
                </span>
                <span className="title">Curtains</span>
              </a>
            </li>
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-lamp-street" />
                </span>
            ...
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-microwave" />
                </span>
                <span className="title">microwave</span>
              </a>
            </li>
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-regular fa-utensils" />
                </span>
                <span className="title">Utensils</span>
              </a>
            </li>
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
                <span className="rbt-cat-icon">
                  <i className="fa-sharp fa-regular fa-flower-tulip" />
                </span>
                <span className="title">Flower Pot</span>
              </a>
            </li>
            <li>
              <a className="rbt-cat-cat-box-1" href="#">
