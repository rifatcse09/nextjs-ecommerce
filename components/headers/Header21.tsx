...
export default function Header21({ sticky = false }) {
            ...
            <div className="mainbar-row @@navigationEnd align-items-center">
              ...
              <div className="header-right rbt-gap--32">
                ...
                <ul className="rbt-quick-access">
                  ...
                  <li
                    className="rbt-access-box rbt-scroll-trigger fade_in animation-order-3 d-none d-md-flex tooltips tooltip-distance-lg"
                  ...
                  <li
                    className="rbt-access-box rbt-scroll-trigger fade_in animation-order-4 rbt-wishlist d-none d-md-flex tooltips tooltip-distance-lg"
