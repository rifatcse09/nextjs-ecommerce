              ...
              <div className="row">
                <div className="col-12">
                  <div className="rbt-component-section-title rbt-gap--4 mb--24 p-0 border-0 text-left">
                    <h5 id="compareReviewModalLabel" className="rbt-title mb--0">
                  ...
                  <table className="rbt-compare-table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        {items.map((product, i) => (
                          <td key={i}>
                            <div className="rbt-compare-values">A4C Online</div>
                          </td>
                        ))}
                      </tr>
                      <tr>
                        ...
                        {items.map((product, i) => (
                          <td key={i}>
                            <div className="rbt-compare-values">Black</div>
                          </td>
                        ))}
                      </tr>
                      <tr>
                        ...
                        {items.map((product, i) => (
                          <td key={i}>
                            <div className="rbt-compare-values">In-Ear</div>
                          </td>
                        ))}
                      </tr>
                      <tr>
